...
**Role:** UX Designer · **Company:** Google, G Suite — Hangouts Meet · **Timeline:** 2018–2019 · **Team:** 12-person UX team dedicated to Meet; collaboration with the Material Design team · **Platform:** Responsive Web, macOS, Windows, Android, Telephone (PSTN) · **Tools:** Sketch, Chromium (prototype), Material Design system · **Status:** Shipped — phone dial-out available on Google Workspace and Google One Premium accounts; standalone app shipped as Google Meet PWA (2021)
