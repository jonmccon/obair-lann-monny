...
semiFeatured: false
images:
  - src: "./content/design/Google-Gemini/GEMINI-10-concept-frame-800.png"
    alt: "Holistic context menu — resting state and broader folder actions"
  - src: "./content/design/Google-Gemini/GEMINI-11-concept-frame-801.png"
    alt: "Drive to Deck — Select to continue, Review generated deck"
  - src: "./content/design/Google-Gemini/GEMINI-13-concept-frame-803.png"
    alt: "Describe the goal — hold to add direction, listening state, output deck"
  - src: "./content/design/Google-Gemini/GEMINI-14-concept-frame-804.png"
    alt: "Tune the goal — color palette, typeface, emphasis tuning"
  - src: "./content/design/Google-Gemini/GEMINI-12-concept-frame-802.png"
    alt: "Shake to Refine — break out into analyzation & grouping, user edits, squeeze back"
  - src: "./content/design/Google-Gemini/GEMINI-15-concept-frame-805.png"
    alt: "Optional outputs — share with notes, present with audio recording"
  - src: "./content/design/Google-Gemini/GEMINI-16-concept-frame-806.png"
    alt: "Drive to Video — analyze & group key scenes, faces, transcription"
  - src: "./content/design/Google-Gemini/GEMINI-17-concept-frame-807.png"
    alt: "Shake to Refine (video) — break back up, remembers analyzation chunks for collaborative editing"
  - src: "./content/design/Google-Gemini/GEMINI-18-concept-frame-808.png"
    alt: "Rotate to Tune — landscape timeline editing, drag & drop"
  - src: "./content/design/Google-Gemini/GEMINI-19-concept-frame-809.png"
    alt: "Hold & drag to Tune — XY graph emphasis dial on a clip"
  - src: "./content/design/Google-Gemini/GEMINI-20-concept-frame-810.png"
    alt: "Zoom on text — expand transcript, collaborative script editing, pinch to see refined video"
  - src: "./content/design/Google-Gemini/GEMINI-21-concept-frame-811.png"
    alt: "Update seed content — new clips emphasized, missing content deprioritized but remembered"
  - src: "./content/design/Google-Gemini/GEMINI-37-s2-phone-454.png"
    alt: "Two subjects rigged simultaneously — Gemini skeleton dots on both the person and the dog"
  - src: "./content/design/Google-Gemini/GEMINI-38-s2-phone-456.png"
    alt: "Early icon radial — three unlabeled bubbles: Image, Video, Text icons"
  - src: "./content/design/Google-Gemini/GEMINI-39-s2-phone-457.png"
    alt: "Labeled icon radial — Video / Image / Text with profile thumbnail at bottom"
  - src: "./content/design/Google-Gemini/GEMINI-30-s1-phone-383.png"
    alt: "Full labeled action state — green/blue/yellow pills, color-coded by action type"
  - src: "./content/design/Google-Gemini/GEMINI-48-s2-phone-476.png"
    alt: "Zone-mapped selector — body regions color-coded as tappable action zones: Emotion/Pose/Background/Style"
  - src: "./content/design/Google-Gemini/GEMINI-47-s2-phone-473.png"
    alt: "Refined bubble radial — Pose / Emotion / Background / Style, Gemini spark center"
  - src: "./content/design/Google-Gemini/GEMINI-45-s2-phone-469.png"
    alt: "Wireframe rig — body pose editing with draggable joint handles"
  - src: "./content/design/Google-Gemini/GEMINI-49-s2-phone-479-rich.png"
    alt: "Green landmark rig — accepted pose, facial feature points, ready to apply"
  - src: "./content/design/Google-Gemini/GEMINI-51-s3-phone-398.png"
    alt: "Emoji ring — spin to select target emotion, overlaid on the face"
  - src: "./content/design/Google-Gemini/GEMINI-23-node-393-fresh.png"
    alt: "Show me more — face thumbnails from camera roll arranged as a ring around the green center dot"
  - src: "./content/design/Google-Gemini/GEMINI-52-s3-phone-399.png"
    alt: "Color picker — drag the handle across the full spectrum to set the grade"
  - src: "./content/design/Google-Gemini/GEMINI-33-s1-phone-400.png"
    alt: "Show me more — camera roll thumbnail strip, emoji bubbles, Show me more / Add someone buttons"
  - src: "./content/design/Google-Gemini/GEMINI-26-polished-441.png"
    alt: "Working sketch — USER SELECTS POSE OWNACTZ, yellow and blue rig markers on face close-up"
  - src: "./content/design/Google-Gemini/GEMINI-25-polished-440-high-child.png"
    alt: "Hand-annotated selfie sketch — face rig concept, drawn directly on the photo"
  - src: "./content/design/Google-Gemini/GEMINI-36-s1-storyboard-423a.png"
    alt: "Gemini globe — 3D geodesic sphere with color-coded pill actions radiating from it"
  - src: "./content/design/Google-Gemini/GEMINI-04-04-refinement-2.png"
    alt: "Dots & Handles — 3-screen AI rig concept, applied across media types"
  - src: "./content/design/Google-Gemini/GEMINI-34-s1-phone-403-richest.png"
    alt: "Supercut persona screen — Gemini contextual collage from phone data: people, places, books, cities"
  - src: "./content/design/Google-Gemini/GEMINI-05-05-whats-that-a.png"
    alt: "Whats That — style spectrum slider, Cottage selected"
  - src: "./content/design/Google-Gemini/GEMINI-06-07-whats-that-c.png"
    alt: "Whats That — slider moved, different aesthetic selected"
  - src: "./content/design/Google-Gemini/GEMINI-07-08-whats-that-d.png"
    alt: "Whats That — slider at another position, full range visible"
  - src: "./content/design/Google-Gemini/GEMINI-09-14-android-407.png"
    alt: "Refine — Gemini personality radar chart: friendly / simple / light / assertive / amused / formal"
  - src: "./content/design/Google-Gemini/GEMINI-53-s3-phone-405.png"
    alt: "Gemini over NYT article — action pills: Summarize, Play summary, Who is in this story?"
  - src: "./content/design/Google-Gemini/GEMINI-35-s1-phone-406.png"
    alt: "Article screen expanded — audio summary playing, Send to Erika contact pill, Can I trust this article?"
  - src: "./content/design/Google-Gemini/GEMINI-22-daily-1205-full.png"
...
{% image "./GEMINI-36-s1-storyboard-423a.png", "Gemini globe — 3D geodesic sphere with color-coded pill actions radiating from it" %}
...
{% image "./GEMINI-04-04-refinement-2.png", "Dots & Handles — 3-screen AI rig concept, applied across media types" %}
...
<div class="three-column">
{% image "./GEMINI-05-05-whats-that-a.png", "Whats That — style spectrum slider, Cottage selected" %}
{% image "./GEMINI-06-07-whats-that-c.png", "Whats That — slider moved, different aesthetic selected" %}
{% image "./GEMINI-07-08-whats-that-d.png", "Whats That — slider at another position, full range visible" %}
</div>
